...
> Date: 2026-03-02
> Status: Draft
> Based on: `2026-03-02-v1.0-design-exploration.md` (35 design decisions)
...
All 35 decisions are documented in `2026-03-02-v1.0-design-exploration.md` §9 (consolidated decision table). This design document is the architectural implementation of those decisions.
